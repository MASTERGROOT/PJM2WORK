...
-- SELECT SCHEMA_NAME(schema_id) SN,OBJECT_NAME(parent_object_id) ParentObjName, object_id, name 
-- FROM sys.objects 
-- WHERE schema_id = 1
-- ORDER BY ParentObjName;
-- SELECT * FROM Databae
-- SELECT OBJECT_ID('Id') FROM InvoiceARs
-- sp_helpindex InvoiceARs;
