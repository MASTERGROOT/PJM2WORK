...
option(recompile);
/************************************************************************************************************************************************************************/
select * from #TempPORemain WHERE
...
-- 		,(ISNULL(BRMat.BudgetRemainMat,0) /*- ISNULL(mp.POAmount,0)*//*  - ISNULL(PORemain.PORemainAmount,0) */) /*(20)*/	
-- 		 + (ISNULL(BRSub.BudgetRemainSub,0) /*- ISNULL(sp.POAmount,0)*/ /* - ISNULL(SCRemain.SCRemainAmount,0) */) /*(21)*/
...
-- Drop a temporary table called '#s'
